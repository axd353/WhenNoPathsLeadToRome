...
from utils.StoryGRaphPLotter import *
from utils.StoryGraphBatchGenerator import *
...
if __name__ == "__main__":
    ...
    total_num_stories = 300   # Total stories to generate
    ...
    max_facts_list = np.random.randint(40, 65, size=total_num_stories)##number of edges in the story will be sampled from this 
    num_tries = 1000
